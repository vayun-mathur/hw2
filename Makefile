...
OBJS=amazon.o user.o db_parser.o product.o product_parser.o util.o store.o book.o clothing.o movie.o
...
amazon.o: amazon.cpp db_parser.h store.h product_parser.h 
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c amazon.cpp
store.o: store.cpp store.h  datastore.h
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c store.cpp
